...
<body>
  ...
  <div class="preloader">
    <div class="lds-ripple text-center w-100">
      ...
      <h2 class="green-color w-100">Project Lifecycle Management</h2>
    </div>
  </div>
  <div id="main-wrapper">
    <!-- Sidebar Start -->
      ...
      <header class="topbar">
        <div class="with-vertical">
          ...
          <nav class="navbar navbar-expand-lg p-0">
            ...
            <div class="d-block d-lg-none py-0">
              <img class="img-fluid" src="assets/images/logos/logo.png" alt="plm-img" />
            </div>
                ...
                <ul class="navbar-nav flex-row mx-auto ms-lg-auto align-items-center justify-content-center">
                  ...
                  <li class="nav-item dropdown nav-icon-hover-bg rounded-circle">
                    <a class="nav-link" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
                      <img src="assets/images/flag/icon-flag-en.svg" alt="plm-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20" />
                    </a>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                      <div class="message-body">
                        <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                          <div class="position-relative">
                            <img src="assets/images/flag/icon-flag-hu.webp" alt="plm-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20" />
                          </div>
                          <p class="mb-0 fs-3">Hungarian (HU)</p>
                        </a>
                        <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                          <div class="position-relative">
                            <img src="assets/images/flag/icon-flag-ro.webp" alt="plm-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20" />
                          </div>
                          <p class="mb-0 fs-3">Romania (RO)</p>
                        </a>
                      </div>
                    </div>
                  </li>
          ...
          <nav class="navbar navbar-expand-xl container-fluid p-0">
            <ul class="navbar-nav align-items-center">
              ...
              <li class="nav-item d-none d-xl-flex align-items-center">
                <a href="home" class="text-nowrap nav-link">
                  <img src="assets/images/logos/logo.png" alt="plm-img" />
                </a>
              </li>
                    ...
                    <div class="position-relative">
                      <div class="row">
                        ...
                        <div class="col-4 d-none d-lg-flex">
                          <img src="assets/images/backgrounds/mega-dd-bg.svg" alt="mega-dd" class="img-fluid mega-dd-bg" />
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                      <div class="message-body">
                        ...
                        <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                          ...
                          <p class="mb-0 fs-3">Romanian (RO)</p>
                        </a>
                      </div>
                    </div>
                  </li>
